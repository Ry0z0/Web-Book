...
<!--                                    <span class="custom-checkbox">
                                ...
                                <td><fmt:formatNumber type="currency" value="${o.price}" currencyCode="VND" /></td>
                                <td>
...
<!--                <div class="clearfix">
            ...
            <a href="home"><i class="fa-regular fa-circle-left fa-2xl" style="color: rgb(67,93,125);"></i></i></a>
        </div>
        <!-- Edit Modal HTML -->
